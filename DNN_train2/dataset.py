    ...
    def __getitem__(self, index):
        ...
        if self.train and index % 32== 0:
            if self.seen < 4000*32:
               ...
               width = (random.randint(-3,3) + 28)*8
               height = (random.randint(-3,3) + 28)*8
               self.shape = (height, width)
            elif self.seen < 12000*32:
               width = (random.randint(-5,5) + 28)*8
               height = (random.randint(-5,5) + 28)*8
               self.shape = (height, width)
            elif self.seen < 16000*32:
               width = (random.randint(-7,7) + 28)*8
               height = (random.randint(-7,7) + 28)*8
               self.shape = (height, width)
            else: # self.seen < 20000*64:
               width = (random.randint(-9,9) + 28)*8
               height = (random.randint(-9,9) + 28)*8
               self.shape = (height, width)
