	...
	for(int i = 0; i < 16; i++) {
		for(int j = 1; j <= 34; j++) {
			for(int k = 1; k <= 34; k++) {
				...
				{
				case 1:
					conv_1_out_PL[ch*16+i][col*32+j-1][row*32+k-1] = buf[i][j][k];
					break;
				case 2:
					conv_2_out_PL[ch*16+i][col*32+j-1][row*32+k-1] = buf[i][j][k];
					break;
				case 4:
					conv_4_out_PL[ch*16+i][col*32+j-1][row*32+k-1] = buf[i][j][k];
					break;
				case 5:
					conv_5_out_PL[ch*16+i][col*32+j-1][row*32+k-1] = buf[i][j][k];
					break;
				case 7:
					conv_7_out_PL[ch*16+i][col*32+j-1][row*32+k-1] = buf[i][j][k];
					break;
				case 8:
					conv_8_out_PL[ch*16+i][col*32+j-1][row*32+k-1] = buf[i][j][k];
					break;
				case 10:
					conv_10_out_PL[ch*16+i][col*32+j-1][row*32+k-1] = buf[i][j][k];
					break;
				case 11:
					conv_11_out_PL[ch*16+i][col*32+j-1][row*32+k-1] = buf[i][j][k];
					break;
				case 12:
					conv_12_out_PL[ch*16+i][col*32+j-1][row*32+k-1] = buf[i][j][k];
					break;
				default:
